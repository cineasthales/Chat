 ...
 * - SHOW_DEBUG_BACKTRACE: mostra o backtrace quando são apresentadas mensagens de erro.
 * - FILE_READ_MODE: octal selecionado para modo de leitura de arquivo.
 * - FILE_WRITE_MODE: octal selecionado para modo de escrita de arquivo.
 * - DIR_READ_MODE: octal selecionado para modo de leitura de diretório.
 * - DIR_WRITE_MODE: octal selecionado para modo de leitura de diretório.
 * - FOPEN: usados apenas para streams, modos fopen() ou popen().
 * - EXIT: definidos códigos de saída.
 */
